...
namespace Contacts
{
    public partial class Form1 : Form
    {
        ...
        {
            return new SqlConnection("data source= DESKTOP-EL7VRJU\\SQLEXPRESS;integrated security=true;initial catalog=Northwind");
        }
        ...
        private void SubmitContact(Contact C)
        {
            ...
            cmd.CommandText = "INSERT Customers (CustomerID, CompanyName, ContactName, Address, " + "City, Region, PostalCode, Country, " + "Phone, Fax) " + "VALUES (@CustomerID, @CompanyName, @ContactName, @Address, " + "@City, @Region, @PostalCode, @Country, " + "@Phone, @Fax) ";
        ...
        private void exit_label(object sender, EventArgs e)
        {
            Application.Exit();
        }
