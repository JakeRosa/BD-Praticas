...
Entidades:
    ...
    - Encomenda:
        ...
        * Data
        * Fornecedor único
        * Número de unidades (por produto)
        * Nº de Produtos
    - Fornecedor:
        * Nome
        * Número de informação fiscal
        * Endereço
        * Número de Fax
        * Condições de pagamento
        * Código interno (Tipo Fornecedor)
    - TipoFornecedor:
        * Código interno
        * Designação 
```
...
```
Relação entre produto e encomenda
    - Grau: 2 (binária)
    - Cardinalidade: muitos-para-muitos
    - Obrigatorieade de participação:
        * Uma encomenda contém um ou mais produtos (Obrigatório)
        * Um produto pode estar contido em várias encomendas

Relação entre produto e armazém
    - Grau: 2 (binária)
    - Cardinalidade: 1-para-N
    - Obrigatoriedade de participação:
        * Um armazém pode conter vários produtos
        * Um produto pode estar contido em armazém

Relação entre encomenda e fornecedor
    - Grau: 2 (binária)
    - Cardinalidade: 1-para-N
    - Obrigatoriedade de participação:
        * Um fornecedor fornece várias encomendas (Obrigatorio)
        * Uma encomenda tem de ser fornecida por um fornecedor (Obrigatorio)

Relaçáo entre fornecedor e tipoFornecedor
     - Grau: 2 (binária)
     - Cardinalidade: 1-para-N
     - Obrigatoriedade de participação:
        * Fornecedor tem Tipo de Fornecedor (Obrigatório)
```
