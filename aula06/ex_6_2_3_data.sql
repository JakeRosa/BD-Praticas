...
-- Inserir dados na tabela Farmacia
...
-- Inserir dados na tabela Farmaceutica
INSERT INTO Farmaceutica (numReg, nome, endereco) VALUES
(905, 'Roche', 'Estrada Nacional 249'),
(906, 'Bayer', 'Rua da Quinta do Pinheiro 5'),
(907, 'Pfizer', 'Empreendimento Lagoas Park E7'),
(908, 'Merck', 'Alameda Fernão Lopes 12');

-- Inserir dados na tabela Farmaco
INSERT INTO Farmaco (FarmReg, nome, formula) VALUES
...
INSERT INTO Prescricao (numPresc, numUtente, numMedico, nomeFarmacia, dataProc) VALUES
...
-- Inserir dados na tabela Presc_farmaco
INSERT INTO Presc_farmaco (numPresc, FarmReg, nomeFarmaco) VALUES
